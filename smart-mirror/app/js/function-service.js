var FUNCTIONSERVICE = {
	...
	whoare_u : function($scope) {
		...
		$scope.focus = "whoissmartmirror";
         ...
         wherebubal : function($scope) {
                console.log("pls tell me train time ");
                if(responsiveVoice.voiceSupport()) {
	...
	lightOn : function() {
		...
		var cmd_path = "/home/pi/MYCOLOR/white.sh";
		/* 커맨드 명령*/
	...
	lightOff : function() {
		...
		var cmd_path = "/home/pi/MYCOLOR/turnoff.sh";
		/* 커맨드 명령*/
